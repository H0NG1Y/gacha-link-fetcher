...
$arguments = @("/nologo", "/target:winexe", "/out:$OutputPath", "/win32icon:$iconPath", "/r:System.Windows.Forms.dll", "/r:System.Drawing.dll", "/r:System.Web.Extensions.dll") + $sourceFiles
& $compiler $arguments
